...
import MasterController from './master-controller.jsx';
...
import ExampleCode from './ExampleCode.jsx';//示例程序
import LoginBut from './LoginBut.jsx';//登录
import Tooltip from './Tooltip.jsx';//悬浮窗

import FirmwareUpdate from './firmware-update.jsx';
...
class MenuBar extends React.Component {
    ...
    handleClickNew () {
        ...
        this.props.onRequestCloseFile();//关闭 File 菜单界面

        //创建新工程
        if (readyToReplaceProject) {
            this.props.onClickNew(this.props.canSave && this.props.canCreateNew);
        }
        this.props.onRequestCloseFile();//确认关闭 File 菜单界面
    }
    handleClickNewWindow () {
    ...
    getSaveToComputerHandler (downloadProjectCallback) {
        return () => {
            this.props.onRequestCloseFile();// 关闭文件菜单
            downloadProjectCallback();//保存逻辑
            //不知道下面干啥用的
    ...
    render () {
        ...
        return (
            ...
            >
                    ...
                    {(this.props.canManageFiles) && (
                        ...
                        >
                            ...
                            >
                                <MenuItem
                                    isRtl={this.props.isRtl}
                                    onClick={this.handleClickNew}//新文件
                                >
                                    {newProjectMessage}
                                </MenuItem>
                                {/* {this.props.onClickNewWindow && (
                                ...
                                <MenuSection>
                                    ...
                                    <SB3Downloader
                                        ...
                                        modeValue={this.props.modeValue}//传入当前模式
                                    >
                ...
                {/* 主控器 */}
                <Tooltip text={this.props.intl.formatMessage({id: 'gui.tooltip.chooseBoard',defaultMessage: 'Choose Board'})} position="bottom">
                    <MasterController onClick={this.props.onClickMaster} value={this.props.extensionName} />
                </Tooltip>

                {/* 设备连接 */}
                <Tooltip text={this.props.intl.formatMessage({id: 'gui.tooltip.connect',defaultMessage: 'Connect'})} position="bottom">
                    <ConnectDevice onClick={() =>this.props.onClickConnect(this.props.masterSelectedState)}></ConnectDevice>
                </Tooltip>
                
                {/* 固件更新 */}
                <Tooltip text={this.props.intl.formatMessage({id: 'gui.tooltip.uploadFirmware',defaultMessage: 'Upload Firmware'})} position="bottom">
                    <FirmwareUpdate onClick={() =>this.props.onClickFirmware(this.props.masterSelectedState)}></FirmwareUpdate>
                </Tooltip>
                ...
                {/* 模式切换 */}
                <ModeToggle setIsLoading={this.props.setIsLoading} value={this.props.modeValue} device ={this.props.extensionName} newfile={this.props.onClickNew}/>
