...
const control = function (isInitialSetup, isStage, targetId, colors,mode) {
    // Note: the category's secondaryColour matches up with the blocks' tertiary color, both used for border color.
    const showInteractiveBlocks = (mode === 'interactive'); 
...
const operators = function (isInitialSetup, isStage, targetId, colors, mode) {
    const showInteractiveBlocks = (mode === 'interactive'); 
...
const makeToolboxXML = function (isInitialSetup, isStage = true, targetId, categoriesXML = [],
    costumeName = '', backdropName = '', soundName = '', colors = defaultBlockColors,mode = 'interactive' ) {//新增参数，默认互动模式
    ...
    const controlXML = moveCategory('control') || control(isInitialSetup, isStage, targetId, colors.control, mode);
    const sensingXML = moveCategory('sensing') || sensing(isInitialSetup, isStage, targetId, colors.sensing);
    const operatorsXML = moveCategory('operators') || operators(isInitialSetup, isStage, targetId, colors.operators, mode);
