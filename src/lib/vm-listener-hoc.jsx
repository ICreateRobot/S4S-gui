...
const vmListenerHOC = function (WrappedComponent) {
    class VMListener extends React.Component {
        constructor (props) {
            ...
            this.props.vm.runtime.on('EXTENSION_UNLOADED', this.handleExtensionRemoved);//监听删除扩展事件
        ...
        componentWillUnmount () {
            ...
            this.props.vm.runtime.off('EXTENSION_UNLOADED', this.handleExtensionRemoved);
        ...
        handleExtensionRemoved (id) {
            console.log(`[GUI] Extension ${id} removed, refreshing blocks toolbox...`);
            try {
                // 延时等待 VM 内部清理完成
                setTimeout(() => {
                    // 通知 GUI 刷新 blocks 工具栏
                    this.props.vm.emitWorkspaceUpdate();
                }, 200);
            } catch (e) {
                console.error('Error refreshing after extension removal:', e);
            }
        }
