...
const MODAL_MASTER = 'masterModal';//主控选择弹窗
const MODAL_CONNECT='connectModal'//连接
const MODAL_FIRMWARE='firmwareModal'//固件

const SET_MASTER_SELECTED = 'scratch-gui/modals/SET_MASTER_SELECTED';//选择设备
const setMasterSelected = (selected) => ({
...
const reducer = function (state, action) {
    ...
    case SET_MASTER_SELECTED:
        return {...state, masterSelectedState: action.selected};
    default:
        return state;
    }
};
