...
import deviceConnectionReducer from './device-connection';//设备连接状态
import sunReducer from './sun';



//import vmDownloadReducer from './vmDownload';//下载模式vm(暂时禁用，会导致vm混乱)
...
const guiReducer = combineReducers({
    ...
    tw: twReducer,
    vm: vmReducer,
   // vmDownload: vmDownloadReducer,//下载模式vm
    vmStatus: vmStatusReducer,
    workspaceMetrics: workspaceMetricsReducer,
    deviceConnectionState: deviceConnectionReducer,
    sun: sunReducer//提前的所有页面状态
});
