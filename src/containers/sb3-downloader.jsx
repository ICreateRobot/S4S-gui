...
class SB3Downloader extends React.Component {
    ...
    async saveToHandle (handle) {
        ...
        const writable = await handle.createWritable();//创建可写文件对象
        this.startedSaving();//显示“正在保存”状态
        ...
        await new Promise((resolve, reject) => {
            ...
            const jszipStream = this.props.saveProjectSb3Stream('arraybuffer',this.props.modeValue);//返回 JSZip 的可读流

            const abortController = new AbortController();//错误与中止控制
...
SB3Downloader.propTypes = {
    ...
    modeValue: PropTypes.string//当前模式
};
